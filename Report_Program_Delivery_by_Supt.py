...
class Solution:
    ...
    def create_excel_report_template(self, title_cells, subtitle_cells, column_widths):
        ...
        ws = wb.create_sheet("Program Delivery by Supt") 
        ...
        columns = ['Superintendent', 'School District','Primary Program Type',
    ...
    def connect_to_database(self):
        ...
        cursor.execute("EXEC [dbo].[USPCCTriannualReportPSSuperintendent]")
        return cursor
    ...
    def main_Program_Delivery_by_District_Supt(self):
        ...
        column_widths = [40,40,40,20,20,20,20,20,20]
...
if __name__ == "__main__":
        Tab3 = Solution()
        Tab3.main_Program_Delivery_by_District_Supt()   
