...
print_cell_formats(r'C:\Users\Ywang36\OneDrive - NYCDOE\Desktop\Non-Redacted City Council Triennial Report SY24.xlsx', 'RS Delivery by District', 'C3:H99') # Type: <class 'int'> - Format: General Type: <class 'float'> - Format: 0%
print_cell_formats(r'C:\Users\Ywang36\OneDrive - NYCDOE\Desktop\Non-Redacted City Council Triennial Report SY24.xlsx', 'RS Delivery by Supt', 'C3:H99') # Type: <class 'int'> - Format: General Type: <class 'float'> - Format: 0%
