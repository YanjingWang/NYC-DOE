...
class Solution:
    ...
    def create_excel_report_template(self, title_cells, subtitle_cells, column_widths):
        ...
        for row in ws.iter_rows(min_row=1, max_row=4208, min_col=1, max_col=26):
            for cell in row:
    ...
    def write_data_to_excel(self, ws, data, start_row):
        ...
        cell_ranges = ['C3:C4207', 'E3:E4207', 'G3:G4207']
                ...
                for cell in row:
                    if cell.value is not None and isinstance(cell.value, str):
                        try:
                            ...
                            pass
        cell_ranges = ['D3:D4207', 'F3:F4207', 'H3:H4207']
        for cell_range in cell_ranges:
            for row in ws[cell_range]:
                for cell in row:
                    if cell.value is not None and isinstance(cell.value, str):
