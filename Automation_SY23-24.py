...
def RelatedServices():
    ...
    # os.startfile(r'R:\SEO Analytics\Reporting\Critical Processes\Related Services\SY23-24')
    # 1). create folders we need
    MDSY23_24 = "\\\\CENTRAL.NYCED.ORG\DoE$\SEO Analytics\Processing\Data Mart Files\Mandate_Distribution_SY23-24"
    ...
    currentdateCSDfolder = 'R:\SEO Analytics\Reporting/Related Services\Output Files\SY 23-24\MandatedServices_{0}'.format(date.today().strftime("%Y-%m-%d"))
    currentdateCharterfolder = 'R:\SEO Analytics\Reporting/Related Services\Output Files\SY 23-24 Charter\MandatedServicesCharter_{0}'.format(date.today().strftime("%Y-%m-%d"))
...
def MandatedServices():
    os.startfile(r'R:\SEO Analytics\Reporting\Critical Processes\Related Services\SY23-24')
    #mylocalMandate = r'C:\Users\YWang36\Desktop\SESIS Mandated Services Report - AUTOMATED - SY23-24.xlsm'
    file = 'R:\SEO Analytics\Processing\Data Mart Files\Templates\SESIS Mandated Services Report\SESIS Mandated Services Report - AUTOMATED - SY23-24.xlsm'
    os.popen(file, 'r')
...
def MandatedServicesAuto():
    ...
    # excel_file_path = 'C:\Users\YWang36\Desktop\SESIS Mandated Services Report - AUTOMATED - SY23-24.xlsm'
    excel_file_path = 'R:\SEO Analytics\Processing\Data Mart Files\Templates\SESIS Mandated Services Report\SESIS Mandated Services Report - AUTOMATED - SY23-24.xlsm'
    # open the Excel file
...
# def MandatedServices():
#     path1 = Path(r'R:/SEO Analytics/Reporting/Critical Processes/Related Services/SY23-24')
#     subprocess.run(['open', str(path1)])

#     file_path = Path(r'R:/SEO Analytics/Processing/Data Mart Files/Templates/SESIS Mandated Services Report/SESIS Mandated Services Report - AUTOMATED - SY23-24.xlsm')
