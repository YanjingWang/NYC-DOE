...
class Solution:
    ...
    def Report_Program_Delivery(self):
        title_cells = [
            {"cell": "A1", "value": "October 31, 2023 Number & Percentage of Students Receiving Recommended Special Education Programs ", "merge_cells": "A1:G1"},
            

        ]

        subtitle_cells = [
            # {"cell": "B3", "value": "October 31, 2022 Number & Percentage of Students Receiving Recommended Special Education Programs by Primary Program Type (All Languages)", "merge_cells": "A1:G1"},
        ...
        results_bytab1= self.fetch_data_by_tab1(cursor)
        self.write_data_to_excel(ws, results_bytab1, start_row=3)
