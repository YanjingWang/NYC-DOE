...
class Solution:
    ...
    def create_excel_report_template(self, title_cells, subtitle_cells, column_widths):
        ...
        ws = wb.create_sheet("Program Delivery by Dist Biling") 
    ...
    def main_Program_Delivery_by_District_Bil(self):
        title_cells = [
            {"cell": "A1", "value": "October 31, 2022 Number & Percentage of Students Receiving Bilingual Recommended Special Education Programs", "merge_cells": "A1:H1"},
...
if __name__ == "__main__":
        Tab1_4 = Solution()
        Tab1_4.main_Program_Delivery_by_District_Bil()   
