...
class Solution:
    ...
    def create_excel_report_template(self, title_cells, subtitle_cells, column_widths):
        ...
        ws = wb.create_sheet("RS Delivery Nov - Jan") 
        ...
        columns = ['Superintendent', 'District',
                'Mandates', 'Date', 'Percent Full Encounter', 'Percent Partial or No Encounter']
    ...
    def main_RS_Delivery_Nov_Jan(self):
        title_cells = [
            {"cell": "A1", "value": "Percentage of Students Receiving Recommended Related Services - October 31, 2022 vs January 16, 2023- by Superintendent", "merge_cells": "A1:F1"},
...
if __name__ == "__main__":
        Tab1_4 = Solution()
        Tab1_4.main_RS_Delivery_Nov_Jan()   
