...
class Solution:
    ...
    def create_excel_report_template(self, title_cells, subtitle_cells, column_widths):
        ...
        ws = wb.create_sheet("Program Delivery by District") 
        ...
        columns = ['School District', 'Primary Program Type',
    ...
    def connect_to_database(self):
        ...
        cursor.execute("EXEC [Mike].[USPCCTriannualReportPSDistrict]" )
        return cursor
    ...
    def write_data_to_excel(self, ws, data, start_row):
        ...
        for row in ws['B3':'B'+str(self.lastrow)]:
            for cell in row:
        ...
        # make A column and B column bold
        for row in ws['A1': 'B'+str(self.lastrow)]:
            for cell in row:
                cell.font = Font(bold=True, size=12)
...
if __name__ == "__main__":
        Tab1_4 = Solution()
        Tab1_4.main_Program_Delivery_by_District()   
