...
class Solution:
    ...
    def create_excel_report_template(self, title_cells, subtitle_cells, column_widths):
        ...
        for row in ws.iter_rows(min_row=1, max_row=8500, min_col=1, max_col=26):
            for cell in row:
    ...
    def connect_to_database(self):
        ...
        cursor.execute("EXEC [Mike].[USPCCTriannualReportRSSchoolLevel]")
        return cursor
                ...
                for cell in row:
                    if cell.value is not None and isinstance(cell.value, str):
                        try:
                            ...
                            pass
        cell_ranges = ['D3:D8357', 'F3:F8357', 'H3:H8357']
        for cell_range in cell_ranges:
            for row in ws[cell_range]:
                for cell in row:
                    if cell.value is not None and isinstance(cell.value, str):
