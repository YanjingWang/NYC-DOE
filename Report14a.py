...
class Solution:
    ...
    def create_excel_report_template(self, title_cells, subtitle_cells, column_widths):
        ...
        ws = wb.create_sheet("Report 14 = BIP Citywide")
        ...
        self.format_header(ws, 'B3', 'Primary Program Type', columns, column_letters, 30, header_fill_color, column_fill_color,  black_boarder_all_medium, header_font)
    ...
    def connect_to_database(self):
        ...
        cursor.execute("[DEV].[USPCCAnnaulReport14a] @tableNameCCStudentRegisterR814=?", params)
        return cursor
    # Fetch data for "Report 8b = IEP Service Recs by Race"
    def fetch_data_by_tab14(self,cursor):
        query_bytab14 = '''
        select * from ##Report_14a
    ...
    def write_data_to_excel(self, ws, data, start_row):
        ...
        #             cell.value = ' ' + str(cell.value)  # Append space to the value
        #         cell.alignment = openpyxl.styles.Alignment(horizontal='left')
    def Report_14a_BIP_Citywide(self):
        title_cells = [
            {"cell": "B1", "value": "Report 14 Number and Percentage of Students with a Behavioral Intervention Plan Citywide", "merge_cells": "B1:F1"},
        ...
        column_widths = [5, 70, 30, 30, 30, 30]
...
if __name__ == "__main__":
        Tab14a = Solution()
        Tab14a.Report_14a_BIP_Citywide()     
