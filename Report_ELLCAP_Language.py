...
class Solution:
    ...
    def create_excel_report_template(self, title_cells, subtitle_cells, column_widths):
        ...
        self.format_header(ws, 'A5', "Language", columns, column_letters, 60, header_fill_color, column_fill_color,  black_boarder_all_medium, header_font)
    ...
    def fetch_data_by_Language(self,cursor):
        ...
        ,ReceivingD75
        FROM #Register as a
        left join( select PSOutcomeLanguage
                    ,count(studentid) as 'TotalBIL'
                    FROM #Register
                    where [BilingualProgramRec] is not null 
                    group by PSOutcomeLanguage) as z on a.PSOutcomeLanguage = z.PSOutcomeLanguage
        left join( select PSOutcomeLanguage
                    ,count(studentid) as 'BilICT'
                    FROM #Register
                    where [BilingualProgramRec] = 'Integrated Co-Teaching Services'
                    and AdminDistrict <> 75
                    group by PSOutcomeLanguage) as b on a.PSOutcomeLanguage = b.PSOutcomeLanguage
        left join( select PSOutcomeLanguage
                    ,count(studentid) as 'BilSC'
                    FROM #Register
                    where [BilingualProgramRec] = 'Special Class'
                    and AdminDistrict <> 75
                    group by PSOutcomeLanguage) as c on a.PSOutcomeLanguage = c.PSOutcomeLanguage
        left join( select PSOutcomeLanguage
                    ,count(studentid) as 'BilSETSS'
                    FROM #Register
                    where [BilingualProgramRec] = 'SETSS'
                    and AdminDistrict <> 75
                    group by PSOutcomeLanguage) as J on a.PSOutcomeLanguage = J.PSOutcomeLanguage
        left join( select PSOutcomeLanguage
                    ,count(studentid) as 'BilMulti'
                    FROM #Register 
                    where [BilingualProgramRec] = 'Multiple Programs'
                    and AdminDistrict <> 75
                    group by PSOutcomeLanguage) as d on a.PSOutcomeLanguage = d.PSOutcomeLanguage
        left join( select PSOutcomeLanguage
                    ,count(studentid) as 'D75'
                    FROM #Register 
                    where [BilingualProgramRec] is not null
                    and AdminDistrict = 75
                    group by PSOutcomeLanguage) as e on a.PSOutcomeLanguage = e.PSOutcomeLanguage
        left join( select PSOutcomeLanguage
                    ,count(studentid) as 'TotalReceiving'
                    FROM #Register
                    where [BilingualProgramRec] is not null 
                    and ReceivingBilingual = 'FULLY RECEIVING'
                    group by PSOutcomeLanguage) as Y on a.PSOutcomeLanguage = Y.PSOutcomeLanguage
        left join( select PSOutcomeLanguage
                    ...
                    and AdminDistrict <> 75
                    and ReceivingBilingual = 'FULLY RECEIVING'
                    group by PSOutcomeLanguage) as f on a.PSOutcomeLanguage = f.PSOutcomeLanguage
        left join( select PSOutcomeLanguage
                    ...
                    and AdminDistrict <> 75
                    and  ReceivingBilingual = 'FULLY RECEIVING'
                    group by PSOutcomeLanguage) as g on a.PSOutcomeLanguage= g.PSOutcomeLanguage
        left join( select PSOutcomeLanguage
                    ...
                    and AdminDistrict <> 75
                    and  ReceivingBilingual = 'FULLY RECEIVING'
                    group by PSOutcomeLanguage) as K on a.PSOutcomeLanguage= K.PSOutcomeLanguage
        left join( select PSOutcomeLanguage
                    ...
                    and AdminDistrict <> 75
                    and ReceivingBilingual = 'FULLY RECEIVING'
                    group by PSOutcomeLanguage) as h on a.PSOutcomeLanguage= h.PSOutcomeLanguage
        left join( select PSOutcomeLanguage
                    ...
                    and AdminDistrict = 75
                    and ReceivingBilingual = 'FULLY RECEIVING'
                    group by PSOutcomeLanguage) as i on a.PSOutcomeLanguage = i.PSOutcomeLanguage
        group by 
        a.PSOutcomeLanguage
        ,TotalBIL
        ,BilICT
    ...
    def Report_Grade(self):
        ...
        results_bytab1 = self.fetch_data_by_Language(cursor)
