...
class Solution:
    ...
    def create_excel_report_template(self, title_cells, subtitle_cells, column_widths):
        ...
        ws = wb.create_sheet("Transportation by School")

        # Set fill color for cells from A1 to Zn to white
        white_fill = PatternFill(start_color="FFFFFF", end_color="FFFFFF", fill_type="solid")
        for row in ws.iter_rows(min_row=1, max_row=1600, min_col=1, max_col=26):
            for cell in row:
        ...
        self.format_header(ws, 'A2', "Primary Program Type", columns, column_letters, 30, header_fill_color, column_fill_color,  black_boarder_all_medium, header_font)
    ...
    def connect_to_database(self):
        ...
        cursor.execute("[Mike].[USPCCTriannualReportSTSchoolLevel]")
        return cursor
    ...
    def fetch_data_by_tab10(self,cursor):
        ...
        cursor.execute(query_bytab10)
        results_bytab10 = cursor.fetchall()
        return results_bytab10
    ...
    def write_data_to_excel(self, ws, data, start_row):
        ...
        for row in ws['A3':'A1544']:
            for cell in row:
                if cell.value is not None:
                    cell.value = str(cell.value) + ' '
                    cell.font = Font(bold=True, size=12)
                cell.alignment = openpyxl.styles.Alignment(horizontal='left')
        for row in ws['B3':'G1544']:
            for cell in row:
        ...
        for row in ws['A1544': 'G1544']:
            for cell in row:
                cell.border = black_boarder_all
                cell.font = Font(bold=True, size=12)

        cell_ranges = ['A3:A34', 'B3:B1544', 'D3:D1544', 'F3:F1544']
                ...
                for cell in row:
                    if cell.value is not None and isinstance(cell.value, str):
                        try:
                            ...
                            pass
        cell_ranges = ['C3:C1544', 'E3:E1544','G3:G1544']
        for cell_range in cell_ranges:
            for row in ws[cell_range]:
                for cell in row:
                    if cell.value is not None and isinstance(cell.value, str):
    ...
    def Report_Transportation_by_School(self):
        title_cells = [
            {"cell": "A1", "value": "October 31, 2023 Number & Percentage of Special Transportation Recommendations with Busing Assignment", "merge_cells": "A1:G1"},
            

        ]

        subtitle_cells = [
            # {"cell": "B3", "value": "October 31, 2023 Number & Percentage of Special Transportation Recommendations with Busing Assignment", "merge_cells": "A1:G1"},
        ...
        results_bytab10= self.fetch_data_by_tab10(cursor)
        self.write_data_to_excel(ws, results_bytab10, start_row=3)
...
if __name__ == "__main__":
        Tab10 = Solution()
        Tab10.Report_Transportation_by_School()                                                                  