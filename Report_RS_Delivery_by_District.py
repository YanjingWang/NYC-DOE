...
class Solution:
    ...
    def create_excel_report_template(self, title_cells, subtitle_cells, column_widths):
        ...
        # ws = wb.create_sheet("RS Delivery by District") 
        wb = openpyxl.load_workbook(r'C:\Users\Ywang36\OneDrive - NYCDOE\Desktop\CityCouncil\Non-Redacted City Council Triennial Report_CW.xlsx')
        ws = wb.create_sheet("RS Delivery by District")
        ...
        columns = ['School District', 'Related Services Recommendation Type',
    ...
    def connect_to_database(self):
        ...
        cursor.execute("EXEC [Mike].[USPCCTriannualReportRSDistrict]")
        return cursor
...
if __name__ == "__main__":
        Tab6 = Solution()
        Tab6.main_RS_Delivery_by_District()   
