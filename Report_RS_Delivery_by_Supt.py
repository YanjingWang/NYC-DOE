...
class Solution:
    ...
    def create_excel_report_template(self, title_cells, subtitle_cells, column_widths):
        ...
        ws = wb.create_sheet("RS Delivery by Supt") 

        # Set fill color for cells from A1 to Zn to white
        white_fill = PatternFill(start_color="FFFFFF", end_color="FFFFFF", fill_type="solid")
        for row in ws.iter_rows(min_row=1, max_row=360, min_col=1, max_col=26):
            for cell in row:
        ...
        columns = ['Superintendent', 'District(s)',
                'Related Services Recommendation Type', 'Full Encounter', 'Percent Full Encounter', 'Partial Encounter', 'Percent Partial Encounter', 'No Encounter','Percent No Encounter']
    ...
    def connect_to_database(self):
        ...
        cursor.execute("EXEC [Mike].[USPCCTriannualReportRSSuperintendent]")
        return cursor
    ...
    def write_data_to_excel(self, ws, data, start_row):
        ...
        for row in ws['A360': 'I360']:
            for cell in row:
                cell.border = black_boarder_all
                cell.font = Font(bold=True, size=12)

        cell_ranges = ['D3:D360', 'F3:F360', 'H3:H360']
                ...
                for cell in row:
                    if cell.value is not None and isinstance(cell.value, str):
                        try:
                            ...
                            pass
        cell_ranges = ['E3:E360', 'G3:G360', 'I3:I360']
        for cell_range in cell_ranges:
            for row in ws[cell_range]:
                for cell in row:
                    if cell.value is not None and isinstance(cell.value, str):
    ...
    def main_Program_Delivery_by_District_Supt(self):
        title_cells = [
            {"cell": "A1", "value": "October 31, 2023 Number & Percentage of Related Service Recommendations with Encounter Recorded by Service Type", "merge_cells": "A1:I1"},
        ...
        column_widths = [50,50,50,20,20,20,20,20,20]
...
if __name__ == "__main__":
        Tab8 = Solution()
        Tab8.main_Program_Delivery_by_District_Supt()   
